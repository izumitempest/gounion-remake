...
export const TopNav = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-[#09090b]/80 backdrop-blur-xl border-b border-white/5 z-[100]">
      <div className="max-w-[1600px] mx-auto h-full flex items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-4">
          ...
          <Link to="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-900/20">
        ...
        <div className="flex-1 max-w-lg mx-4 md:mx-12 hidden md:block">
          <div className="relative group">
            ...
            <input 
              ...
              className="w-full bg-zinc-900/50 border border-white/5 rounded-xl py-2 pl-10 pr-4 text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-violet-500/50 focus:bg-zinc-900/80 transition-all text-sm"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to={`/profile/${user?.username}`} className="ml-2">
            <div className="p-0.5 rounded-full border border-white/10 hover:border-violet-500 transition-colors">
              <img 
